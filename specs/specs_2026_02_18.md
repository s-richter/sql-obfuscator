# SQL Obfuscator Re-Creation Specification (Current State)

This document is a re-creation specification of the app **as it exists now** in this repository, intended for an LLM or engineer to rebuild feature parity.
